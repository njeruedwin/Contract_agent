...
def risk_reporter(user_prompt: str):
    """
    ...
    with project_client:
        ...
        agent = project_client.agents.create_agent(
            ...
            name="report-agent",
            instructions="You are an AI agent that generates a risk report based on the data provided in the prompt. create the report, and save the report as a .txt file.",
        ...
        for annotation in messages.file_path_annotations:
            ...
            print(f"File saved as {Path(annotation.text).name}")
